...
<head>
	...
	<!--[if lte IE 7]><link href="<?php echo bloginfo('template_url'); ?>css/fix_ie7.css" rel="stylesheet" type="text/css" media="screen"/><![endif]-->
	<!--[if lt IE 7]><link href="<?php echo bloginfo('template_url'); ?>css/fix_ie6.css" rel="stylesheet" type="text/css" media="screen"/><![endif]-->
...
<!-- END LAYOUT (Header) [] -->
	...
	<div id="mainBar">
		...
		<nav id="nMain">
			<ul class="variable_black">
				<li id="linkMain"><a href="<?php exho get_option('home'); ?>" title="View: <?php bloginfo('name'); ?> Homepage"><?php blog_info('name'); ?></a></li>
